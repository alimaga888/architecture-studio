...
Занимаюсь веб-разработкой 2 года — от простых лендингов до сложных SPA с 3D-визуализацией и админ-панелями. Целеустремлённый разработчик с опытом работы в команде. Быстро обучаюсь новым технологиям, умею решать сложные задачи и всегда довожу проекты до конца.
...
Практические проекты с реальным деплоем

---

## 💼 Мои проекты

### 🏗️ [ALYAZHE — Архитектурное бюро](https://github.com/alimaga888/architecture-studio)
**Технологии:** React, Three.js, Supabase, PostgreSQL

Сайт архитектурного бюро с интерактивными 3D моделями проектов.

**Особенности:**
- 🎨 3D визуализация домов через Three.js
